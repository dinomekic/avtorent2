      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '28px 16px' }}>
        ...
        {activeTab === 'orders' && (
          <>
            ...
            {loading ? <div style={{ textAlign: 'center', padding: 32, color: '#9ca3af' }}>Učitavanje...</div>
              : filtered.length === 0 ? (
                        ...
                        <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                          ...
                          {o.status === 'done' && (
                            <span style={{ fontSize: 12, color: '#1D9E75', fontWeight: 500 }}>
                              ✓ Završeno {o.completed_at ? new Date(o.completed_at).toLocaleTimeString('sr-RS', { hour: '2-digit', minute: '2-digit' }) : ''}
                            </span>
                          )}
                        </div>
                      </div>
