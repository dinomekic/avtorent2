      ...
      <main style={{ maxWidth: 1000, margin: '0 auto', padding: '28px 16px' }}>
        ...
        {activeTab === 'outdoor' && (
          <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 12, padding: '20px 24px' }}>
            ...
            <div style={{ fontSize: 13, color: '#6b7280', marginBottom: 20 }}>QR kod koji vodi na stranicu sa outdoor aktivnostima u Crnoj Gori. Postavite ga na flajer i dijelite sa gostima.</div>

            {outdoorSlug && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, background: '#0a1628', borderRadius: 12, padding: '16px' }}>
                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${encodeURIComponent(`${siteUrl}/outdoor/${outdoorSlug}`)}&format=png`}
                  alt="Outdoor QR"
