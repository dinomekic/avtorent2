...
<body style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#333">
  ...
  <div style="padding:28px 24px">
    ...
    <p>Vaša rezervacija je prihvaćena. Posjetite naš portal <a href="https://www.rent-cars.me/moje" style="color:#1D9E75">https://www.rent-cars.me/moje</a> kako biste pregledali rezervacije i unijeli potrebne podatke za pripremu ugovora.</p>
  ...
  <div style="background:#f9f9f9;padding:16px 24px;text-align:center;font-size:12px;color:#999">
    AvtoRent Montenegro · info@rent-cars.me · rent-cars.me
  </div>
</body>
</html>`
